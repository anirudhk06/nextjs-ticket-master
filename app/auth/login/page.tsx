    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{
            height: "50%",
            background:
              "radial-gradient(ellipse at bottom left, rgba(245,166,35,0.07) 0%, transparent 70%)",
          }}
        />
        ...
        <div className="relative">
          ...
          >
            Login to access your tickets, manage bookings, and never miss an
            event in your city.
          </p>
        </div>
        ...
        <div className="relative flex gap-8">
          {[
            ...
            <div key={s.label}>
              <div
                className="th-font-display text-2xl"
      ...
      <div className="flex flex-1 items-center justify-center px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <button
            type="button"
            className="flex w-full items-center justify-center gap-3 rounded-lg py-3 text-[13px] font-semibold"
            style={{
